...
const minimumSummaryDatesSizes = 18 * 5; // preencher com quadrados para preencher a tela
    ...
    return(
        <View className="flex-1 bg-background px-8 pt-16">
            ...
            <View className="flex-row mt-6 mb-2">
                {
            // Usando o DAY_SIZE que foi importado de HabitDay
            ...
            <View className="flex-row flex-wrap"> 
             {
                //o flex-wrap que vai ser usado para respeitar o tamanho da tela.
